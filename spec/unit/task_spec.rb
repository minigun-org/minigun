...
RSpec.describe Minigun::Task do
  ...
  describe "class methods" do
    ...
    describe "stage definition methods" do
      ...
      it "adds stages to the pipeline" do
        ...
        pipeline = task_class.instance_variable_get(:@_minigun_pipeline)
  ...
  describe "instance methods without mocks" do
    ...
    describe "#run without mocks" do
      it "processes items through the entire pipeline" do
        ...
        def real_task.run
          ...
          if @current_batch && @current_batch.any?
            @consumed_batches << @current_batch
          end
        end
        ...
        expect(real_task.processed_items).to match_array([1, 2, 3, 4, 5])
        ...
        expect(real_task.consumed_batches.flatten).to match_array([2, 4, 6, 8, 10])
      end
    end
  end
end 