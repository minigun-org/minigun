...
RSpec.describe 'README Examples Integration' do
  ...
  describe 'Diamond-Shaped Pipeline' do
    ...
    it 'executes the diamond-shaped pipeline as defined in the README' do
      ...
      # Verify source items
      expect(task.source_items).to eq(%w[item1 item2 item3])
      ...
      expect(task.validated_items).to eq(%w[item1 item2 item3])
      ...
      expect(task.transformed_a_items).to eq(%w[item1_transformed_a item2_transformed_a item3_transformed_a])
      ...
      expect(task.transformed_b_items).to eq(%w[item1_transformed_b item2_transformed_b item3_transformed_b])
  ...
  describe 'Priority Processing Pipeline' do
    ...
    it 'executes the priority pipeline as defined in the README' do
      ...
      expect(task.vip_users).to(be_all { |u| u[:vip] })
      expect(task.regular_users).to(be_all { |u| !u[:vip] })
  ...
  describe 'Load Balancing Pipeline' do
    ...
    it 'executes the load balancing pipeline as defined in the README' do
      ...
      expect(task.queue_assignments.values.uniq.sort).to eq(%i[queue_1 queue_2 queue_3])
      ...
      expect(task.processed_items[:queue_1]).to(be_all { |r| r.include?('Worker 1') })
      expect(task.processed_items[:queue_2]).to(be_all { |r| r.include?('Worker 2') })
      expect(task.processed_items[:queue_3]).to(be_all { |r| r.include?('Worker 3') })
