...
module Minigun
  ...
  #       output << item
  #     end
  #     processor :transform do |item, output|  # Raises StageNameConflictError
  #       output << item
  #     end
  #   end
  ...
  #
  # @example
  #   in_ipc_forks(4, restart_policy: :invalid) do  # Raises InvalidOptionError
  ...
  #       output << item
  #     end
  #     processor :b, routes_to: :a do |item, output|  # Raises CyclicDependencyError
  #       output << item
  #     end
  #   end
  ...
  # @example
  #   pipeline do
  #     processor :a, routes_to: :nonexistent do |item, output|  # Raises UnresolvedReferenceError
  #       output << item
  #     end
  #   end
  ...
  #   in_ipc_forks(4) do
  #     processor :work do |item, output|
  #       output << lambda { }  # Raises SerializationError - lambdas can't be marshaled
  #     end
  #   end
  ...
  #     processor :process do |item, output|  # Raises ClusterWorkerNotFoundError
  #       output << item
  #     end
  #   end
  class ClusterWorkerNotFoundError < ClusterError
  ...
  #       # After 3 failed attempts, raises ClusterDeliveryError
  #       output << unreliable_operation(item)
  #     end
  #   end
  class ClusterDeliveryError < ClusterError
  ...
  #     # Raises ClusterTimeoutError if 4 workers don't connect within 10 seconds
  #     processor :work do |item, output|
  #       output << item
  #     end
  #   end
  ...
  # Backwards-compatible aliases for Cluster module namespace
  module Cluster
    Error = ClusterError
    ConnectionError = ClusterConnectionError
    WorkerNotFoundError = ClusterWorkerNotFoundError
    DeliveryError = ClusterDeliveryError
    TimeoutError = ClusterTimeoutError
  end
end
